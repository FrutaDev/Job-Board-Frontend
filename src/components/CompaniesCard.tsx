    ...
    return (
        <>
            {companies?.map((company: Company) => (
                <div key={company.id} className="flex items-center justify-around border border-gray-200 rounded-xl w-1/3 p-5 hover:border-[#D5A521] hover:shadow-xl hover:border-1.5 transition-all hover:bg-gray-500/8 duration-300 cursor-pointer shadow-lg">
