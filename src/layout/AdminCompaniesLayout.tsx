            ...
            <header className="w-full bg-white border-b border-gray-200 py-3 px-6 md:px-10 flex flex-wrap items-center justify-between gap-4 shadow-sm">
                ...
                <div className="flex-1 max-w-md">
                    <form className="relative flex items-center">
                        <input type="text" placeholder="Buscar empresas..." className="w-full bg-gray-100 border border-transparent focus:bg-white focus:border-[#D5A521] outline-none rounded-lg py-1.5 pl-4 pr-10 text-sm transition-all" />
